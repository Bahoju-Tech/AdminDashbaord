...
export default function InstructorsPage() {
  ...
  const currentData = filteredInstructors.slice(startIndex, endIndex);

  return (
    <div className="flex-1 overflow-auto">
      {/* Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Instructor</h1>
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium">Add New Instructor</span>
          </button>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
          ...
          <table className="w-full min-w-[900px]">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium text-gray-600">Applicant Name</th>
                <th className="text-left px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium text-gray-600">Email Address</th>
                <th className="text-left px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium text-gray-600">Expertise</th>
                <th className="text-left px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-medium text-gray-600">Experience</th>
              ...
              {currentData.map((instructor) => (
                ...
                >
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <span className="text-xs sm:text-sm text-gray-900">{instructor.name}</span>
                  </td>
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <span className="text-xs sm:text-sm text-gray-900">{instructor.email}</span>
                  </td>
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <span className="text-xs sm:text-sm text-gray-900">{instructor.expertise}</span>
                  </td>
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <span className="text-xs sm:text-sm text-gray-900">{instructor.experience}</span>
                  </td>
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <span className="text-xs sm:text-sm font-medium text-green-600">{instructor.status}</span>
                  </td>
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <span className="text-xs sm:text-sm text-gray-900">{instructor.date}</span>
                  </td>
                  <td className="px-3 sm:px-6 py-3 sm:py-4">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <button 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between px-3 sm:px-6 py-3 sm:py-4 border-t border-gray-200 gap-3 sm:gap-0">
          <div className="text-xs sm:text-sm text-gray-600 text-center sm:text-left">
            Showing {startIndex + 1} to {Math.min(endIndex, filteredInstructors.length)} of {filteredInstructors.length} results
          </div>
        ...
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="flex items-start justify-between mb-4 sm:mb-6 gap-4">
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Register New Instructor</h2>
              <p className="text-xs sm:text-sm text-gray-500">Fill in the details to register a new instructor</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Expertise</label>
                <input
                  type="text"
                  value={expertise}
              ...
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Experience</label>
                <input
                  type="text"
                  value={experience}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Area of Interest</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Link to Portfolio</label>
                <input
                  type="text"
                  value={portfolio}
            ...
            {/* Bio/Motivation */}
            <div>
              <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Bio/Motivation</label>
              <textarea
                value={motivation}
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-[20px] w-full max-w-2xl max-h-[90vh] overflow-y-auto relative z-10">
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="flex items-start justify-between mb-4 sm:mb-6 gap-4">
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Application Details</h2>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                <div className="text-xs sm:text-sm text-gray-900">{instructor.fullName}</div>
              </div>
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Registration Date</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.registrationDate}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Email Address</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.email}</div>
              </div>
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Phone Number</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.phone}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Expertise</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.expertiseArea}</div>
              </div>
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Experience</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.experienceYears}</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Area of Interest</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.areaOfInterest}</div>
              </div>
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-900 mb-2">Link to portfolio</label>
                <div className="text-xs sm:text-sm text-gray-900">{instructor.portfolio}</div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 mt-6 sm:mt-8">
            <button className="px-4 sm:px-6 py-2.5 sm:py-3 border border-red-300 text-red-600 rounded-lg text-xs sm:text-sm font-medium hover:bg-red-50 transition-colors order-2 sm:order-1">
              Reject
            </button>
      ...
      <div className="bg-white rounded-[20px] w-full max-w-md relative z-10">
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="bg-gray-50 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
            <h3 className="font-semibold text-sm sm:text-base text-gray-900 mb-2">{instructor.name}</h3>
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      <div className="bg-white rounded-[20px] w-full max-w-md relative z-10">
        <div className="p-4 sm:p-6 md:p-8">
          ...
          <div className="flex items-start justify-between mb-4 sm:mb-6 gap-4">
            <div className="flex-1">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Delete Instructor</h2>
              <p className="text-xs sm:text-sm text-gray-500">Are you sure you want to delete this instructor?</p>
            </div>
            <button
              onClick={onClose}
              className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 hover:bg-gray-200 transition-colors flex-shrink-0"
